...
# data as tuple, data_titles as tuple, precision as tuple in same order as data,
# shape = 'hor' or 'ver', box = 'hor' or 'ver' or 'full' or 'none'
# precision values should be str with only 1 decimal, so: '3.5f', '.3i', '.f', etc.
